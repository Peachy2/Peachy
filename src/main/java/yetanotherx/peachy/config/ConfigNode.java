...
public class ConfigNode {
    ...
    public ConfigNode(Map<String, Object> root) {
        this.root = root;
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ConfigNode> getNodeList(String path, List<ConfigNode> def) {
        List<Object> raw = getList(path);

        if (raw == null) {
            return def != null ? def : new ArrayList<ConfigNode>();
        }
        ...
        for (Object o : raw) {
            if (o instanceof Map) {
                list.add(new ConfigNode((Map<String, Object>) o));
            }
        }
    ...
    public ConfigNode getNode(String path) {
        ...
        if (raw instanceof Map) {
            return new ConfigNode((Map<String, Object>) raw);
        }
    ...
    @SuppressWarnings("unchecked")
    public Map<String, ConfigNode> getNodes(String path) {
        Object o = getProperty(path);
        ...
        if (o == null) {
            ...
            for (Map.Entry<String, Object> entry : ((Map<String, Object>) o).entrySet()) {
                if (entry.getValue() instanceof Map) {
                    nodes.put(entry.getKey(), new ConfigNode((Map<String, Object>) entry.getValue()));
                }
            }
